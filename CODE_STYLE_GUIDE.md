...
*   Если имя состоит из нескольких слов, то каждое слово начинается с большой буквы. При этом словом считается 
    ...
    При этом некоторые общепринятые аббревиатуры можно полностью писать большими буквами, 
...
*   Не используйте директивы `#region` в коде. 
    Если часть кода можно объединить в `#region`, то возможно этот код можно вынести в отдельный класс.
