...
internal static class BoundingBoxExtensions {
    ...
    public static BoundingBoxXYZ GetTransformedBoundingBox(this BoundingBoxXYZ bb, Transform transform) {
        var pt0 = new XYZ(bb.Min.X, bb.Min.Y, bb.Min.Z);
        var pt1 = new XYZ(bb.Max.X, bb.Min.Y, bb.Min.Z);
        var pt2 = new XYZ(bb.Max.X, bb.Max.Y, bb.Min.Z);
        var pt3 = new XYZ(bb.Min.X, bb.Max.Y, bb.Min.Z);
    ...
    public static BoundingBoxXYZ GetCommonBoundingBox(this IEnumerable<BoundingBoxXYZ> bbs) {
        return bbs.IsIntersected() ? bbs.GetIntersectedBb() : bbs.GetUnitedBb();
    }
