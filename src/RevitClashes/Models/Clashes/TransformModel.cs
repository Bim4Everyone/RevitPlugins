...
internal class TransformModel : IEquatable<TransformModel> {
    ...
    public bool Equals(TransformModel other) {
        return other is not null && (ReferenceEquals(this, other) || (Equals(BasisX, other.BasisX)
    ...
    public bool IsAlmostEqualTo(Transform transform) {
        return transform is not null && Origin is not null && BasisX is not null && BasisY is not null && BasisZ is not null && Origin.GetXYZ().IsAlmostEqualTo(transform.Origin)
