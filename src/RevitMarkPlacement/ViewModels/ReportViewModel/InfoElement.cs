...
internal class InfoElement {
    public static InfoElement FamilyAnnotationMissing =>
        new() {
    ...
    public static InfoElement AnnotationParameterMissing =>
        new() {
    ...
    public static InfoElement ElevationParameterMissing =>
        new() {
