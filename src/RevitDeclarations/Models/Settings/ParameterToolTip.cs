namespace RevitDeclarations.Models {
    internal class ParameterToolTip {
        ...
        public string FilterRoomsParamToolTip => "Текстовый параметр. Используется \n" +
        ...
        public string GroupBySectionParamToolTip => "Параметр, по которому помещения группируются " +
            "по секциям. Если помещения имеют одинаковое значение этого параметра, " +
        ...
        public string GroupByGroupParamToolTip => "Параметр, по которому помещения группируются " +
            "по квартирам. Если помещения на одном этаже имеют одинаковое значение этого параметра и находятся " +
            "в одной секции, то считается, что они относятся к одной квартире.";
