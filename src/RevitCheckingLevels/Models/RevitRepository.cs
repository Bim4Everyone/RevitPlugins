...
internal class RevitRepository {
    ...
    public void UpdateElevations(IEnumerable<LevelCreationName> levels) {
        using var transaction = Document.StartTransaction("Обновление отметок уровня");
        foreach(var levelCreationName in levels.Where(item => !item.DuplicateName)) {
