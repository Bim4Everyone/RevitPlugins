...
internal class LevelParserImpl {
    ...
    private readonly List<ILevelBlock> _levelBlocks = [];
    ...
    public LevelInfo ReadLevelInfo() {
        ...
        var levelInfo = new LevelInfo { Level = Level, Errors = _errors, LevelBlocks = _levelBlocks };
    ...
    private void ReadLevelName(LevelInfo levelInfo, string levelName) {
        ...
        string[] splittedLevelName = levelName.Split(new[] { ' ' },
    ...
    private void ReadBlockName(LevelInfo levelInfo, string blockName) {
        ...
        if(blockName.Contains('.')) {
            ...
            string[] blockRange = blockName.Split(new[] { ',' },
                StringSplitOptions.RemoveEmptyEntries);
