...
internal class MainViewModel : BaseViewModel {
    ...
    private ColorHelper _selectedColor = new(0, 0, 0);
    private ColorHelper _color1 = new(15, 150, 190);
    private ColorHelper _color2 = new(250, 190, 20);
    private ColorHelper _color3 = new(240, 100, 70);
    private ColorHelper _color4 = new(150, 190, 50);
    private ColorHelper _color5 = new(230, 70, 90);
    ...
    public ColorHelper Color1 {
        get => _color1;
        set => RaiseAndSetIfChanged(ref _color1, value);
    }
    ...
    public ColorHelper Color2 {
        get => _color2;
        set => RaiseAndSetIfChanged(ref _color2, value);
    }
    ...
    public ColorHelper Color3 {
        get => _color3;
        set => RaiseAndSetIfChanged(ref _color3, value);
    }
    ...
    public ColorHelper Color4 {
        get => _color4;
        set => RaiseAndSetIfChanged(ref _color4, value);
    }
    ...
    public ColorHelper Color5 {
        get => _color5;
        set => RaiseAndSetIfChanged(ref _color5, value);
    }
    ...
    private void Paint() {
        ...
        using(var transaction = _revitRepository.Document.StartTransaction("Документатор пилонов")) {
            ...
            foreach(var view in _revitRepository.AllViews) {

                foreach(var el in elemsForWork) {
        ...
        _revitRepository.ActiveUIDocument.Selection.SetElementIds([]);
