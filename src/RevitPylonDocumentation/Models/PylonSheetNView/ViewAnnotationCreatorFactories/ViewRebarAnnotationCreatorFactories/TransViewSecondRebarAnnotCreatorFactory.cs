...
internal class TransViewSecondRebarAnnotCreatorFactory : IAnnotationCreatorFactory {
    public ViewAnnotationCreator CreateAnnotationCreator(MainViewModel mvm, RevitRepository repository,
        ...
        return new TransViewSecondRebarAnnotCreator(mvm, repository, sheetInfo, view);
    }
}
