...
internal class TransViewThirdRebarAnnotCreatorFactory : IAnnotationCreatorFactory {
    public ViewAnnotationCreator CreateAnnotationCreator(MainViewModel mvm, RevitRepository repository,
        ...
        return new TransViewThirdRebarAnnotCreator(mvm, repository, sheetInfo, view);
    }
}
