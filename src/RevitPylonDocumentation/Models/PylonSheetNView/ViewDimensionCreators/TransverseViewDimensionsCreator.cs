...
internal class TransverseViewDimensionsCreator {

    internal TransverseViewDimensionsCreator(MainViewModel mvm, RevitRepository repository, PylonSheetInfo pylonSheetInfo) {
        ViewModel = mvm;
