...
internal class TransverseViewMarksCreator {
    ...
    internal TransverseViewMarksCreator(MainViewModel mvm, RevitRepository repository, PylonSheetInfo pylonSheetInfo, PylonView pylonView) {
        ViewModel = mvm;
