...
internal class DocumentData : IDocumentData {
    private readonly List<IDuctData> _ductData = [];
    private readonly List<IPipeData> _pipeData = [];
    private readonly List<IPipeInsulationData> _pipeInsulationData = [];
    ...
    public void AddPipeInsulationData(ICollection<IPipeInsulationData> data) {
        ...
        foreach(var ductInsulationData in data) {
