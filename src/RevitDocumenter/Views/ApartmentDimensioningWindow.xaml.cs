...
/// </summary>
public partial class ApartmentDimensioningWindow {
    /// <summary>
    /// Инициализирует главное окно плагина.
    /// </summary>
    public ApartmentDimensioningWindow(
    ...
    /// Используется для сохранения положения окна.
    /// </remarks>
    public override string ProjectConfigName => nameof(ApartmentDimensioningWindow);
