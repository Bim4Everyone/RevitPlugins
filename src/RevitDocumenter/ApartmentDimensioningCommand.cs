...
public class ApartmentDimensioningCommand  : BasePluginCommand {
    /// <summary>
    /// Инициализирует команду плагина.
    /// </summary>
    public ApartmentDimensioningCommand () {
        PluginName = "Размеры квартир";
    }
    ...
    protected override void Execute(UIApplication uiApplication) {
        ...
        kernel.BindMainWindow<ApartmentDimensioningViewModel, ApartmentDimensioningWindow>();
        ...
        Notification(kernel.Get<ApartmentDimensioningWindow>());
    }
}
