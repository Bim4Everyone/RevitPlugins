...
internal class TasksInfoVM : BaseViewModel {
    ...
    public TasksInfoVM(PluginConfig pluginConfig, RevitRepository revitRepository, CreatingARDocsVM creatingARDocsVM) {
    ...
    private void AddTask() {
        ...
        TasksForWork.Add(new TaskInfoVM(_revitRepository.RegexForBuildingPart, _revitRepository.RegexForBuildingSection, TasksForWork.Count + 1));
    }
    ...
    private void SelectSpecs(object obj) {
        ...
        TaskInfoVM task = obj as TaskInfoVM;
        if(task != null) {
