...
internal class ViewOptionsVM : BaseViewModel {
    ...
    public bool WorkWithViews {
        get => _workWithViews;
        set => RaiseAndSetIfChanged(ref _workWithViews, value);
    }

    public List<ViewFamilyType> ViewFamilyTypes {
        get => _viewFamilyTypes;
        set => RaiseAndSetIfChanged(ref _viewFamilyTypes, value);
    }

    public ViewFamilyType SelectedViewFamilyType {
        get => _selectedViewFamilyType;
        set => RaiseAndSetIfChanged(ref _selectedViewFamilyType, value);
    }
    ...
    public string ViewNamePrefix {
        get => _viewNamePrefix;
        set => RaiseAndSetIfChanged(ref _viewNamePrefix, value);
    }


    public ViewOptions GetViewOption() {

        var viewOptions = new ViewOptions(_pluginConfig, _revitRepository) {
