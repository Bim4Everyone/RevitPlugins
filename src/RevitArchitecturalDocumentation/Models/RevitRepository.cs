...
internal class RevitRepository {
    ...
    public ViewPlan FindViewByName(string viewName) {
        return new FilteredElementCollector(Document)
    ...
    public ScheduleSheetInstance GetSpecFromSheetByName(ViewSheet viewSheet, string specName) {
        return viewSheet.GetDependentElements(new ElementClassFilter(typeof(ScheduleSheetInstance)))
    ...
    /// </summary>
    public ObservableCollection<ViewPlan> GetSelectedViewPlans() {
        return new ObservableCollection<ViewPlan>(ActiveUIDocument.Selection.GetElementIds()
