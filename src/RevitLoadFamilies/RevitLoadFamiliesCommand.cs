...
using RevitLoadFamilies.ViewModels;
using RevitLoadFamilies.Views;

namespace RevitLoadFamilies;
...
public class RevitLoadFamiliesCommand : BasePluginCommand {
    /// <summary>
    /// Инициализирует команду плагина.
    /// </summary>
    public RevitLoadFamiliesCommand() {
        PluginName = "RevitLoadFamilies";
    }
