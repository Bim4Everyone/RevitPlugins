...
internal static class RevitConstants {
    ...
    private static readonly ICollection<BuiltInCategory> _parentCategories = [
    ...
    // Вложенные / зависимые категории
    private static readonly ICollection<BuiltInCategory> _dependentCategories = [
    ...
    /// <summary>
    /// Метод получения родительских категорий
    /// </summary>
    public static ICollection<BuiltInCategory> GetParentBuiltInCategories() {
        return _parentCategories;
    }

    /// <summary>
    /// Метод получения вложенных/зависимых категорий
    /// </summary>
    public static ICollection<BuiltInCategory> GetDependentBuiltInCategories() {
        return _dependentCategories;
    }

    /// <summary>
    /// Метод получения всех категорий
    /// </summary>
    public static ICollection<BuiltInCategory> GetDefaultBuiltInCategories() {
        return _parentCategories
            .Concat(_dependentCategories)
            .ToArray();
    }
}
