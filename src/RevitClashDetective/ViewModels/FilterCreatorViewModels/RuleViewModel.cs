...
internal class RuleViewModel : BaseViewModel, IСriterionViewModel {
    ...
    public bool IsEmpty() {
        return SelectedRuleEvaluator?.RuleEvaluator?.Evaluator is not Models.Evaluators.RuleEvaluators.FilterHasNoValue
            and not Models.Evaluators.RuleEvaluators.FilterHasValue
    ...
    public string GetErrorText() {
        ...
        return SelectedRuleEvaluator.RuleEvaluator.Evaluator is Models.Evaluators.RuleEvaluators.FilterHasValue
           or Models.Evaluators.RuleEvaluators.FilterHasNoValue
            ? null
    ...
    private bool CanValueEdit() {
        return SelectedRuleEvaluator.RuleEvaluator.Evaluator is not Models.Evaluators.RuleEvaluators.FilterHasValue
           and not Models.Evaluators.RuleEvaluators.FilterHasNoValue;
    }
