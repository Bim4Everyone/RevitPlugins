...
internal class RebarElement : ICommonElement {
    ...
    private readonly Dictionary<double, double> _massPerLengthDict = new() {
        { 4, 0.098},
        { 5, 0.144},
        { 6, 0.222},
        { 7, 0.302},
    ...
    private readonly Dictionary<double, double> _overlapCoefDict = new() {
        { 8, 1.034},
        { 10, 1.043},
        { 12, 1.051},
        { 14, 1.06},
    ...
    public double Calculate() {
        ...
        double baseMassEd = calcInLinearMeters == 1
            ? massPerUnitLength
            : Math.Round(lengthInMm / 1000 * massPerUnitLength, 2, MidpointRounding.AwayFromZero);
