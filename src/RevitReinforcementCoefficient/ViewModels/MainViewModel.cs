...
internal class MainViewModel : BaseViewModel {
    ...
    public DesignTypeListVM DesignTypesList {
        ...
        set => RaiseAndSetIfChanged(ref _designTypesList, value);
    }

    public List<string> DockPackages {
        get => _dockPackages;
        set => RaiseAndSetIfChanged(ref _dockPackages, value);
    }

    public string SelectedDockPackage {
        get => _selectedDockPackage;
        set => RaiseAndSetIfChanged(ref _selectedDockPackage, value);
    }

    public List<string> ElemSections {
        get => _elemSections;
        set => RaiseAndSetIfChanged(ref _elemSections, value);
    }

    public string SelectedElemSection {
        get => _selectedElemSection;
        set => RaiseAndSetIfChanged(ref _selectedElemSection, value);
    }

    public string FilterValueForNoFiltering {
        get => _filterValueForNoFiltering;
        set => RaiseAndSetIfChanged(ref _filterValueForNoFiltering, value);
    }

    public bool СalcСoefficientOnAverage {
        get => _calcСoefficientOnAverage;
        set => RaiseAndSetIfChanged(ref _calcСoefficientOnAverage, value);
    }
    ...
    private void ShowFormworkElements() {
        ...
        foreach(var designType in DesignTypesList.DesignTypes.Where(o => o.IsCheck)) {
