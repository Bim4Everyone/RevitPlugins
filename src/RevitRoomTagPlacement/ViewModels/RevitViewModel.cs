...
internal abstract class RevitViewModel : BaseViewModel {
    ...
    public bool IsEveryRoom {
        get => PlacementWayByGroups == GroupPlacementWay.EveryRoom; set => PlacementWayByGroups = value ? GroupPlacementWay.EveryRoom : PlacementWayByGroups;
    }

    public bool IsOneRoomPerGroupRandom {
        get => PlacementWayByGroups == GroupPlacementWay.OneRoomPerGroupRandom; set => PlacementWayByGroups = value ? GroupPlacementWay.OneRoomPerGroupRandom : PlacementWayByGroups;
    }

    public bool IsOneRoomPerGroupByName {
        get => PlacementWayByGroups == GroupPlacementWay.OneRoomPerGroupByName; set => PlacementWayByGroups = value ? GroupPlacementWay.OneRoomPerGroupByName : PlacementWayByGroups;
    }

    public PositionPlacementWay PlacementWayByPosition {
        get => _placementWayByPosition;
        set {
            if(_placementWayByPosition == value) {
                return;
            }
    ...
    public bool IsPositionLeftTop {
        get => PlacementWayByPosition == PositionPlacementWay.LeftTop; set => PlacementWayByPosition = value ? PositionPlacementWay.LeftTop : PlacementWayByPosition;
    }

    public bool IsPositionCenterTop {
        get => PlacementWayByPosition == PositionPlacementWay.CenterTop; set => PlacementWayByPosition = value ? PositionPlacementWay.CenterTop : PlacementWayByPosition;
    }

    public bool IsPositionRightTop {
        get => PlacementWayByPosition == PositionPlacementWay.RightTop; set => PlacementWayByPosition = value ? PositionPlacementWay.RightTop : PlacementWayByPosition;
    }

    public bool IsPositionLeftCenter {
        get => PlacementWayByPosition == PositionPlacementWay.LeftCenter; set => PlacementWayByPosition = value ? PositionPlacementWay.LeftCenter : PlacementWayByPosition;
    }

    public bool IsPositionCenterCenter {
        get => PlacementWayByPosition == PositionPlacementWay.CenterCenter; set => PlacementWayByPosition = value ? PositionPlacementWay.CenterCenter : PlacementWayByPosition;
    }

    public bool IsPositionRightCenter {
        get => PlacementWayByPosition == PositionPlacementWay.RightCenter; set => PlacementWayByPosition = value ? PositionPlacementWay.RightCenter : PlacementWayByPosition;
    }

    public bool IsPositionLeftBottom {
        get => PlacementWayByPosition == PositionPlacementWay.LeftBottom; set => PlacementWayByPosition = value ? PositionPlacementWay.LeftBottom : PlacementWayByPosition;
    }

    public bool IsPositionCenterBottom {
        get => PlacementWayByPosition == PositionPlacementWay.CenterBottom; set => PlacementWayByPosition = value ? PositionPlacementWay.CenterBottom : PlacementWayByPosition;
    }

    public bool IsPositionRightBottom {
        get => PlacementWayByPosition == PositionPlacementWay.RightBottom; set => PlacementWayByPosition = value ? PositionPlacementWay.RightBottom : PlacementWayByPosition;
    }

    public RoomTagTypeModel SelectedTagType {
        get => _selectedTagType;
        set => RaiseAndSetIfChanged(ref _selectedTagType, value);
    }

    public string SelectedRoomName {
        get => _selectedRoomName;
        set => RaiseAndSetIfChanged(ref _selectedRoomName, value);
    }

    public double Indent {
        get => _indent;
        set => RaiseAndSetIfChanged(ref _indent, value);
    }
