...
internal class MainViewModel : BaseViewModel {
    ...
    private void AcceptView() {
        using(var transaction = _revitRepository.Document.StartTransaction("Изменение значений параметров")) {
    ...
    private void SetElementsFilters() {
        ...
        _revitElementsView.Filter = item => string.IsNullOrEmpty(RevitElementsFilter) || ((RevitElementViewModel) item).ElemName.IndexOf(RevitElementsFilter, StringComparison.OrdinalIgnoreCase) >= 0;
    }
}
