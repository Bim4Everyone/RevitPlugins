...
internal class OpeningArTaskIncomingUniqueViewModel : BaseViewModel, IOpeningTaskIncomingToKrViewModel,
    IEquatable<OpeningArTaskIncomingUniqueViewModel> {
    private readonly FamilyInstance _opening;
    private readonly Transform _transform;

    public OpeningArTaskIncomingUniqueViewModel(FamilyInstance opening, Transform transform, string status) {
    ...
    public bool Equals(OpeningArTaskIncomingUniqueViewModel other) {
        if(other is null) {
            return false;
        }
    ...
    public override bool Equals(object obj) {
        ...
        return Equals((OpeningArTaskIncomingUniqueViewModel) obj);
    }
