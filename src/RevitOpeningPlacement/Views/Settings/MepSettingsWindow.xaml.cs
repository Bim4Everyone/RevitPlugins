...
public partial class MepSettingsWindow {
    public MepSettingsWindow(
        ...
        Dispatcher.BeginInvoke(
            ...
            () => _rootNavigationView.Navigate(typeof(MepPlacementSettingsPage)));
    }

    public override string PluginName => nameof(RevitOpeningPlacement);
    public override string ProjectConfigName => nameof(MepSettingsWindow);
