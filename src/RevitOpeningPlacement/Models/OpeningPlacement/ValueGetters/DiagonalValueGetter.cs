...
internal class DiagonalValueGetter : IValueGetter<DoubleParamValue> {
    ...
    public DoubleParamValue GetValue() {
        double height = _clash.Element1.GetHeight();
        double width = _clash.Element1.GetWidth();
        ...
        double[] diagonals = new[] { _plane.ProjectVector(dirX * width + dirY * height).GetLength(),
