        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture) {
            try {
                ...
                return status switch {
                    ...
                    "Overlay_Unloaded"
                    or "Overlay_NotFound"
                    or "Overlay_InClosedWorkset" => new BitmapImage(new Uri($"{GetImagePath()}OverlayUnloaded.png")),
                    "Attachment_Loaded" => new BitmapImage(new Uri($"{GetImagePath()}AttachmentLoaded.png")),
                    "Attachment_Unloaded"
                    or "Attachment_NotFound"
                    or "Attachment_InClosedWorkset" => new BitmapImage(new Uri($"{GetImagePath()}AttachmentUnloaded.png")),
