...
namespace RevitOpeningPlacement.Models.OpeningPlacement.ParameterGetters {
    internal class InclinedRoundCurveWallParameterGetter : IParametersGetter {
        ...
        public InclinedRoundCurveWallParameterGetter(MepCurveWallClash clash) {
            _clash = clash;
        }
        ...
        public IEnumerable<ParameterValuePair> GetParamValues() {
            ...
            yield return new InclinedWidthGetter(_clash, new DiameterGetter(_clash)).GetParamValue();
            yield return new InclinedHeightGetter(_clash, new DiameterGetter(_clash)).GetParamValue();
