...
namespace RevitOpeningPlacement.Models.RealOpeningArPlacement.ParameterGetters {
    ...
    internal class SingleRectangleOpeningTaskInWallParameterGetter : IParametersGetter {
        ...
        public IEnumerable<ParameterValuePair> GetParamValues() {
            // габариты отверстия
            yield return new DoubleParameterGetter(RealOpeningPlacer.RealOpeningArHeight, new RectangleOpeningTaskInWallHeightValueGetter(_openingMepTaskIncoming, _pointFinder)).GetParamValue();
